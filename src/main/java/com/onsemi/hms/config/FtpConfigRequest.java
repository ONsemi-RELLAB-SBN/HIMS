...
import com.onsemi.hms.controller.WhRequestController;
...
public class FtpConfigRequest {
    ...
    public void cronRun() throws FileNotFoundException, IOException {
        LOGGER.info("Method REQUEST executed at everyday on 7:00 am. Current time is : " + new Date());
...
//            cell2_0.setCellValue(whRequestList.get(i).getRefId()); 
