...
//    String fileLocation = "";
//
//    @Scheduled(cron = "0 34 16 * * ?") //every 2 minute - cron (sec min hr daysOfMth month daysOfWeek year(optional))
//    public void cronRun() {
...
//                if (listOfFile.getName().equals("shelf name.csv")) {
...
//                            int count = inventoryMgtDao.getCountExistingData(shelfId);
//                            if (count == 0) {
//                                kira++;
