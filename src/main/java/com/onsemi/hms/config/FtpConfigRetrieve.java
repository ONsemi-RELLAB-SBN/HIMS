...
public class FtpConfigRetrieve {
    ...
    public void cronRun() throws FileNotFoundException, IOException {
        ...
        int count = whRetrieveDAO1.getCountYesterday();
        ...
        if (count == 0) {
            ...
            HSSFSheet sheet = workbook.createSheet("Arrival");
            ...
            for(int i=0; i<whRetrieveList.size(); i++) {            
                ...
                System.out.println(whRetrieveList.get(i).getMaterialPassNo());
                
                HSSFCell cell2_2 = contents.createCell(1);
                cell2_2.setCellValue(whRetrieveList.get(i).getEquipmentId());
                System.out.println(whRetrieveList.get(i).getEquipmentId());
                ...
                System.out.println(eType + " @ " + whRetrieveList.get(i).getEquipmentType());
                ...
                System.out.println(qty + " @ " + whRetrieveList.get(i).getQuantity());
