...
public class WhRequestPdf extends AbstractITextPdfViewPotrait {
    ...
    protected void buildPdfDocument(Map<String, Object> model, Document doc,
        ...
        table.addCell(cellHeader);
        cellContent.setPhrase(new Phrase(whRequest.getInventoryRack() + ", " + whRequest.getInventoryShelf(), fontContent));
        table.addCell(cellContent);
        ...
        //7
        cellHeader.setPhrase(new Phrase("Requestor Email", fontHeader));
        table.addCell(cellHeader);
        cellContent.setPhrase(new Phrase(whRequest.getRequestedEmail(), fontContent));
        table.addCell(cellContent);
