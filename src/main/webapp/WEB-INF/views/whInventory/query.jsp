            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-box">
                        ...
                        <form id="update_hardwareinventory_form" class="form-horizontal" role="form" action="${contextPath}/wh/whInventory/query" method="post" style="width: 100%">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <div class="col-lg-3">
                                    <select id="status" name="status" class="form-control">
                                        ...
                                        <option value="Available in Inventory">Available in Inventory</option>
                                        <option value="Unavailable in Inventory">Unavailable in Inventory</option>
                                    </select>
                                </div>
                            </div>  
                            <div class="col-lg-12">
