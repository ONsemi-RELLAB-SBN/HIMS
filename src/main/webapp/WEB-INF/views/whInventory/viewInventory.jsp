                    ...
                    <div class="main-box">
                        ...
                        <form id="update_hardwareinventory_form" class="form-horizontal" role="form" action="${contextPath}/wh/whInventory/viewInventory" method="post" style="width: 100%">
                            ...
                            <div class="form-group col-lg-12" >
                                <label for="inventoryRack" class="col-lg-3 control-label">Rack</label>
                                <div class="col-lg-9">
                                    <select id="rackId" name="rackId" class="js-example-basic-single" style="width: 100%"></select>
                                        <option value="" selected=""></option>
                                        <c:forEach items="${inventoryMgtList}" var="group">
                                            <option value="${group.rackId}" ${group.selected}>${group.rackId}</option>
                                        </c:forEach>
                                </div>
                            </div>
                            <div class="col-lg-12"><br></div>
