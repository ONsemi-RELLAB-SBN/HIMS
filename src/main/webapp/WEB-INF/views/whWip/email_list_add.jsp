...
<!--                            <div class="form-group">
                                ...
                                <div class="col-lg-1">
                                    <input type="checkbox" class="form-control" id="isActive" name="isActive" placeholder="Active?" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="isSystem" class="col-lg-4 control-label">Is System *</label>
                                <div class="col-lg-1">
                                    <input type="checkbox" class="form-control" id="isSystem" name="isSystem" placeholder="System" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="isReceive" class="col-lg-4 control-label">Received WIP [Stress] *</label>
                                <div class="col-lg-1">
                                    <input type="checkbox" class="form-control" id="isReceive" name="isReceive" placeholder="Is Received?" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="isVerify" class="col-lg-4 control-label">Verify WIP [Stress] *</label>
                                <div class="col-lg-1">
                                    <input type="checkbox" class="form-control" id="isVerify" name="isVerify" placeholder="Is Verified?" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="isLoad" class="col-lg-4 control-label">Loading WIP [Stress] *</label>
                                <div class="col-lg-1">
                                    <input type="checkbox" class="form-control" id="isLoad" name="isLoad" placeholder="Is Loading?" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="isUnload" class="col-lg-4 control-label">Unloading WIP [Stress] *</label>
                                <div class="col-lg-1">
                                    <input type="checkbox" class="form-control" id="isUnload" name="isUnload" placeholder="Is Unloading?" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="isShip" class="col-lg-4 control-label">Ship WIP [Stress] *</label>
                                <div class="col-lg-1">
                                    <input type="checkbox" class="form-control" id="isShip" name="isShip" placeholder="Is Shipped?" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="isReceiveStorage" class="col-lg-4 control-label">WIP [Storage] Received *</label>
                                <div class="col-lg-1">
                                    <input type="checkbox" class="form-control" id="isReceiveStorage" name="isReceiveStorage" placeholder="WIP [Storage] Received?" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="isShipStorage" class="col-lg-4 control-label">WIP [Storage] Shipped *</label>
                                <div class="col-lg-1">
                                    <input type="checkbox" class="form-control" id="isShipStorage" name="isShipStorage" placeholder="WIP [Storage] Ship?" value="">
                                </div>
                            </div>-->
