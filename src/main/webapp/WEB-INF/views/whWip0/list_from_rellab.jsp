                    ...
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            ...
                            <div class="filter-block pull-right">
                                <a href="${contextPath}/whWip/0hour_scan" class="btn btn-primary pull-right" style="font-family:'Orbitron', monospace;">
                            ...
                            <table id="dt_spml" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><span>View Detail 02</span></th>
                                ...
                                <tbody>
                                    <c:forEach items="${wipList}" var="wipList" varStatus="whLoop">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="${contextPath}/whWip/0hour_register/${wipList.id}" class="table-link" title="Print List">
                                                    <i class='bx bx-tv bx-md bx-fw'></i>
                                                </a>
                                                <c:out value="${wipList.rmsEvent}"/>
                                            </td>
                                            <c:choose>
                                                <c:when test="${wipList.wipStatus == status}">
                                                    <td><c:out value="${wipList.wipStatus}"/></td>
                                                    <td>
                                                        <a href="${contextPath}/whWip/listVerify/${wipList.requestId}" class="table-button" title="Register">
