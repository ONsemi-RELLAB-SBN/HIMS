<%-- 
    Document   : list_inventory
    Created on : Sep 13, 2023, 10:46:08 AM
    Author     : zbqb9x
--%>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            <h2 class="pull-left">WIP [Storage] Inventory List</h2>
                            <div class="filter-block pull-right">
                                <a href="${contextPath}/wip0hour/request" class="btn btn-primary pull-right" style="font-family:'Orbitron', monospace;">
                                    <i class='bx bx-paper-plane bx-fw'></i> Request List
                                </a>
                            </div>
                            <div class="filter-block pull-right">
                            </div>
                                ...
                                <tbody>
                                    <c:forEach items="${wipData}" var="wipList" varStatus="whLoop">
                                        <tr>
                                            ...
                                            <td><c:out value="${wipList.rack}"/></td>
                                            <td><c:out value="${wipList.shelf}"/></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
