...
<s:layout-render name="/WEB-INF/base/base.jsp">
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <h1>Edit Hardware Retrieve</h1>
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        <h2>Hardware Retrieve Information</h2>
                        <form id="edit_hardwaretrieve_form" class="form-horizontal" role="form" action="${contextPath}/wh/whRetrieve/update" method="post">
                            <input type="hidden" name="id" value="${whRetrieve.id}" />
                            <div class="form-group">
                                <label for="requestBy" class="col-lg-4 control-label">Retrieve By</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="requestBy" name="requestBy" placeholder="Retrieve For" value="${whRetrieve.requestedBy}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="requestType" class="col-lg-4 control-label">Retrieve For *</label>
                                <div class="col-lg-3">
                            ...
                            <div class="form-group" id="pcblistdiv" hidden>
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="equipmentIdPcb" name="equipmentIdPcb" placeholder="PCB Name" value="${whRetrieve.equipmentId}">
                                </div>
                            </div>
                            <div class="form-group" id="typediv" hidden>
                                <label for="type" class="col-lg-4 control-label">Type </label>
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="type" name="type" placeholder="Type" value="${whRetrieve.type}">
                                </div>
                            </div>    
                            <div class="form-group" id="quantitydiv" hidden>
                                <label for="quantity" class="col-lg-4 control-label">Quantity *</label>
                                <div class="col-lg-2">
                                    <input type="text" class="form-control" id="quantity" name="quantity" placeholder="Quantity" value="${whRetrieve.quantity}">
                                </div>
                            </div> 
                            <div class="form-group" id="remarksDiv">
                                <label for="remarks" class="col-lg-4 control-label">Remarks </label>
                                <div class="col-lg-8">
                                    <textarea class="form-control" rows="5" id="remarks" name="remarks">${whRetrieve.remarks}</textarea>
                                </div>
                            </div>
                            <!--approval-->
                            <br>
                            ...
                            <div class="form-group"id="approvalRemarksDiv" hidden>
                                ...
                                <div class="col-lg-8">
                                    <textarea class="form-control" rows="5" id="remarksApprover" name="remarksApprover" readonly>${whRetrieve.remarksApprover}</textarea>
                                </div>
                            </div>
    ...
    <s:layout-component name="page_js_inline">
        <script>
            $(document).ready(function () {
                ...
                var validator = $("#edit_hardwaretrieve_form").validate({
                    rules: {
                        requestType: {
                            required: true
                        },
