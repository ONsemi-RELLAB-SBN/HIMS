...
<s:layout-render name="/WEB-INF/base/base.jsp">
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <h1>Add Hardware Retrieve</h1>
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        <h2>Hardware Retrieve Information</h2>
                        <form id="add_hardwaretrieve_form" class="form-horizontal" role="form" action="${contextPath}/wh/whRetrieve/save" method="post">
                            <div class="form-group">
                                <label for="retrieveBy" class="col-lg-4 control-label">Retrieve By</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="retrieveBy" name="retrieveBy" placeholder="Retrieve For" value="${username}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <s:layout-component name="page_js_inline">
        <script>
            $(document).ready(function () {
                ...
                var validator = $("#add_hardwaretrieve_form").validate({
                    rules: {
                        requestType: {
                            required: true
                        },
