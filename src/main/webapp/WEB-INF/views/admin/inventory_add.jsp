            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        ...
                        <form id="add_parameter_form" class="form-horizontal" role="form" action="${contextPath}/admin/parameterMaster/save" method="post">
                            <div class="form-group">
                                <label for="code" class="col-lg-4 control-label">Code *</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="code" name="code" placeholder="Code" value="${mastercode}" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                       <!--<input type="text" class="form-control" id="remarks" name="remarks" value="${parameterMaster.remarks}">-->
